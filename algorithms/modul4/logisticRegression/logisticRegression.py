...
def generateData():
    ...
    return simulated_features, simulated_labels
...
def logistic_regression(features, target, num_steps=100000, learning_rate=5e-5):
...
def main():
    simulated_features, simulated_labels = generateData()
